                        ...
                        <form class="pt-3 section-create-form" id="create-form" action="<?php echo e(route('stream.store')); ?>" method="POST" novalidate="novalidate">
                            <div class="row">
                                <div class="form-group col-sm-6 col-md-12">
                                    ...
                                    <input id="name" name="name" type="text" placeholder="<?php echo e(__('name')); ?>" class="form-control" required/>
                                </div>
                            </div>
                            <input class="btn btn-theme float-right" id="create-btn" type="submit" value=<?php echo e(__('submit')); ?>>
                        </form>
                    </div>
                </div>
            </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list'
                               data-toggle="table" data-url="<?php echo e(url('stream/show')); ?>" data-click-to-select="true"
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="operate" data-sortable="false" data-events="streamEvents" data-escape="false"><?php echo e(__('action')); ?></th>
                            </tr>
                            </thead>
                        </table>
                    </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-management\resources\views/stream/index.blade.php ENDPATH**/ ?>