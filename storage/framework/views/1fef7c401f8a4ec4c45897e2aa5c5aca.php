            ...
            <div class="col-lg-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form class="create-form pt-3" id="formdata" action="<?php echo e(route('teachers.store')); ?>" enctype="multipart/form-data" method="POST" novalidate="novalidate">
                            <?php echo csrf_field(); ?>
                            <div class="row">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <?php echo Form::number('mobile', null, ['required', 'placeholder' => __('mobile'),'min' => 1 , 'class' => 'form-control remove-number-increment']); ?>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    <label for="image"><?php echo e(__('image')); ?> <span class="text-info text-small">(308px*338px)</span></label>
                                    <input type="file" name="image" class="file-upload-default" accept="image/png,image/jpeg,image/jpg"/>
                                    <div class="input-group col-xs-12">
                                        <input type="text" class="form-control file-upload-info" id="image" disabled="" placeholder="<?php echo e(__('image')); ?>"/>
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <input type="number" name="salary" id="salary" placeholder="<?php echo e(__('Salary')); ?>" class="form-control" min="0" required>
                                </div>
                                <?php if(\App\Services\FeaturesService::hasFeature('Teacher Management')): ?>
                                <div class="form-group col-sm-12 col-md-4">
                                ...
                                <div class="form-group col-sm-12 col-md-4">
                                    ...
                                    <span class="text-danger small"><?php echo e(__('Note :- Activating this will consider in your current subscription cycle')); ?></span>
                                </div>
                                <?php endif; ?>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <table aria-describedby="mydesc" class='table' id='table_list' data-toggle="table"
                                       data-url="<?php echo e(route('teachers.show',[1])); ?>" data-click-to-select="true"
                                    ...
                                    <tr>
                                        ...
                                        <th scope="col" data-field="dob" data-visible="false" data-formatter="dateFormatter"><?php echo e(__('dob')); ?></th>
                                        <th scope="col" data-field="image" data-formatter="imageFormatter"><?php echo e(__('image')); ?></th>
                                        <th scope="col" data-field="staff.qualification"><?php echo e(__('qualification')); ?></th>
                                        <th scope="col" data-field="current_address"><?php echo e(__('current_address')); ?></th>
                                        <th scope="col" data-field="permanent_address"><?php echo e(__('permanent_address')); ?></th>
                                        <th scope="col" data-field="staff.salary" data-visible="false"> <?php echo e(__('Salary')); ?></th>
                                        <th data-events="teacherEvents" scope="col" data-formatter="actionColumnFormatter" data-field="operate" data-escape="false"><?php echo e(__('action')); ?></th>
                                    </tr>
                                    </thead>
                                </table>
                            </div>
    ...
    <div class="modal fade" id="editModal" data-backdrop="static" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-xl" role="document">
            <div class="modal-content">
                ...
                <form id="editdata" class="edit-form" action="<?php echo e(url('teachers')); ?>" novalidate="novalidate" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-sm-12 col-md-12 col-lg-4">
                                <label><?php echo e(__('mobile')); ?> <span class="text-danger">*</span></label>
                                <?php echo Form::number('mobile', null, ['required', 'min' => 1 , 'placeholder' => __('mobile'), 'class' => 'form-control remove-number-increment', 'id' => 'mobile']); ?>

                            </div>

                            <div class="form-group col-sm-12 col-md-12 col-lg-4">
                                <label><?php echo e(__('dob')); ?> <span class="text-danger">*</span></label>
                                <?php echo Form::text('dob', null, ['required', 'placeholder' => __('dob'), 'class' => 'datepicker-popup-no-future form-control', 'id' => 'edit-dob']); ?>

                                <span class="input-group-addon input-group-append"></span>
                            </div>
                            <div class="form-group col-sm-12 col-md-12 col-lg-4">
                                <label for="edit-image"><?php echo e(__('image')); ?> <span class="text-info text-small">(308px*338px)</span></label><br>
                                
                                <input type="file" name="image" class="file-upload-default" accept="image/png,image/jpeg,image/jpg"/>
                                <div class="input-group col-xs-12">
                                    <input type="text" class="form-control file-upload-info" id="edit-image" disabled="" placeholder="<?php echo e(__('image')); ?>"/>
                                    <span class="input-group-append">
                                        <button class="file-upload-browse btn btn-theme" type="button"><?php echo e(__('upload')); ?></button>
                                    </span>
                                </div>
                            ...
                            <div class="form-group col-sm-12 col-md-4">
                                ...
                                <input type="number" name="salary" min="0" id="edit_salary" placeholder="<?php echo e(__('Salary')); ?>" class="form-control" required>
                            </div>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-management\resources\views/teacher/index.blade.php ENDPATH**/ ?>