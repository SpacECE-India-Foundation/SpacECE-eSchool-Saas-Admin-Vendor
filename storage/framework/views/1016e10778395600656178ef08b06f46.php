                    ...
                    <div class="card-body">
                        <form class="create-form school-registration-form school-registration-validate" enctype="multipart/form-data" action="<?php echo e(route('schools.store')); ?>" method="POST" novalidate="novalidate">
                            ...
                            <div class="bg-light p-4 mt-4">
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="school_domain"><?php echo e(__('domain')); ?></label>
                                        <div class="input-group mb-3">
                                                <input type="text" class="form-control domain-pattern" name="domain" placeholder="<?php echo e(__('domain')); ?>" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            ...
                            <div class="bg-light p-4 mt-4">
                                ...
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="admin_first_name"><?php echo e(__('first_name')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="admin_first_name" id="admin_first_name" placeholder="<?php echo e(__('first_name')); ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="admin_last_name"><?php echo e(__('last_name')); ?> <span class="text-danger">*</span></label>
                                        <input type="text" name="admin_last_name" id="admin_last_name" placeholder="<?php echo e(__('last_name')); ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-4">
                                        <label for="admin_contact"><?php echo e(__('contact')); ?> <span class="text-danger">*</span></label>
                                        <input type="number" name="admin_contact" id="admin_contact" min="0" placeholder="<?php echo e(__('contact')); ?>" class="form-control remove-number-increment" required>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="form-group col-sm-12 col-md-6">
                                        <label for="admin_email"><?php echo e(__('email')); ?> <span class="text-danger">*</span></label>
                                        <input type="email" name="admin_email" id="admin_email" placeholder="<?php echo e(__('email')); ?>" class="form-control" required>
                                    </div>
                                    <div class="form-group col-sm-12 col-md-6">
                                        ...
                                        <div class="input-group col-xs-12">
                                            <input type="text" class="form-control file-upload-info" disabled="" placeholder="<?php echo e(__('image')); ?>" required aria-label=""/>
                                            <span class="input-group-append">
                                                <button class="file-upload-browse btn btn-theme" type="button"><?php echo e(__('upload')); ?></button>
                                            </span>
                                        </div>
                    ...
                    <div class="card-body">
                        ...
                        <table aria-describedby="mydesc" class='table' id='table_list'
                            ...
                            <tr>
                                ...
                                <th scope="col" data-field="tagline"><?php echo e(__('tagline')); ?></th>
                ...
                <form id="edit-form" class="pt-3 edit-form" action="<?php echo e(url('schools')); ?>">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            <label for="school_domain"><?php echo e(__('domain')); ?></label>
                            <div class="input-group mb-3">
                                    <input type="text" class="form-control domain-pattern" id="edit_domain" name="edit_domain" placeholder="<?php echo e(__('domain')); ?>" aria-label="Recipient's username" aria-describedby="basic-addon2">
                                <div class="input-group-append">
                                    <span class="input-group-text text-body" id="basic-addon2">.<?php echo e($baseUrlWithoutScheme); ?></span>
                                </div>
                            </div>
                        ...
                        <div class="form-group col-sm-12 col-md-3">
                            ...
                            <span class="text-danger text-small">
                                <?php echo e(__('note')); ?>: <?php echo e(__('if_the_school_does_not_currently_have_a_plan_please_assign_from_here_If_there_is_already_an_active_plan_proceed_to_the_subscription_page_to_make_any_necessary_changes')); ?>.
                            </span>
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\school-management\resources\views/schools/index.blade.php ENDPATH**/ ?>